...
inputName.onkeyup = function () {
    ...
    if (name !== '') {
        fetch('https://superheroapi.com/api.php/3884932648302678/search/' + name.trim())
...
function createCard(data) {
    if (data.response === 'error') {
        results.innerHTML = '<div style="margin-top:50px; color:white;">Invalid Name! Try other Name!</div>';
    }
        ...
        for (let i = 0; i < data.results.length && i < 10; i++) {
            ...
            detailsButton.innerHTML = 'About Me';
